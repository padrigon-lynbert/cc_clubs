...
\restrict OyZfpcPB6hFM4MfF8khmXgB8QGyp5pkYA7ULlxTrTth3wY2PKwfOvkd3PmHToWt
...
ALTER TABLE ONLY public.messages DROP CONSTRAINT messages_users_id_fkey;
...
ALTER TABLE ONLY public.landing_page_message DROP CONSTRAINT landing_page_message_users_id_id_7793d00d_fk_auth_user_id;
...
DROP INDEX public.landing_page_message_users_id_id_7793d00d;
...
ALTER TABLE ONLY public.landing_page_message DROP CONSTRAINT landing_page_message_pkey;
...
DROP TABLE public.landing_page_message;
...
--
-- Name: landing_page_message; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.landing_page_message (
...
--
-- Name: landing_page_message_message_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.landing_page_message ALTER COLUMN message_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.landing_page_message_message_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
2	wawa club	2025-09-02 00:49:24.178523+00	wawa wawawawa wawaw awawawa wawawawaw wawawawaw waw aawwawaw awww	0	2	1	club_applications/banners/8d49c66a-920f-4561-8d8e-17010ccd2475.jpg	\N	\N	\N	\N
\.
...
44	landing_page	0014_message	2025-09-01 11:37:18.103764+00
45	clubs	0013_memberapplication_signature_memberapplication_status	2025-09-01 15:28:55.263512+00
\.
...
hryda5ljfw1oq4jl32cv8vj07ltnxyev	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcJ5eYm5qUpWSiWpxSXxxSWlKal5JUo6Ssk5pUlghUomSrUAzvActQ:1utNFs:v7KH0QQgL8LMhQhTAnl5DkVz77D5X5EA8YwLop3ATF0	2025-09-16 09:24:44.78958+00
o97ztuvek1oztrdduiaopfn86jy47bfb	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcJ5eYm5qUpWSiWpxSXxxSWlKal5JUq1AFcWGME:1utTmz:IoAZFSy5lSdBZkYVfDIeBN5RdY65uPSzoHc-KYs5qII	2025-09-16 16:23:21.32153+00
wyzytohrj0fh70thjmol868n4kueru5c	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcN5eYm5qUpWSiWpxSXx-WlpmcmpRUo6Ssk5pUlghea1AJPNHE0:1uswH7:cct8iYpxRGVxakur6taRHceA7j-rSEPkbEenzFJz1_0	2025-09-15 04:36:13.289793+00
...
i26gd73rubm2p16q15xwjj5kgg18h057	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcJ5eYm5qUpWSiWpxSXxxSWlKal5JUo6Ssk5pUlghUomSrUAzvActQ:1utbPv:HIURZK2GEO2ykZVsP7izfaTsfwLybSjlyvfUXJTphAY	2025-09-17 00:32:03.871738+00
kngwwop4yu5vr9q6242txzjvkg2bko7l	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcJ5eYm5qUpWSiWpxSXxxSWlKal5JUq1AFcWGME:1ut30r:UOziYsN_KuDn2ahZyVLAhZxFLWnIzqe8eKgcJLPd9Mo	2025-09-15 11:47:53.060271+00
...
6s3vmcewmr4ymib48wu67xqxcdvh8w9p	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcF5eYm5qUpWSiWpxSXxiSllmcWpRUo6Ssk5pUlghWa1AJSSHFs:1utgPp:EUd_aqZhy5X6Wc7CFFcOkRMuYaeRNbe_Ly5Xp22s568	2025-09-17 05:52:17.054437+00
pqqw0q5z29ni8t2jety00yatnnlm4jow	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcF5eYm5qUpWSiWpxSXxiSllmcWpRUo6Ssk5pUlghUomSrUAzN4cnQ:1utgWb:y-y3RNfpCR7zjvPlfnJ7GSUUUU082PHkKMgLfhpLEH0	2025-09-17 05:59:17.252369+00
tkqcms9bppyk5x2j2eksdry7ysy0jpl3	.eJyrVspNzU1KLYrPyU9PT02Jz8xTsiopKk3VgYlnpihZGcF5eYm5qUpWSiWpxSXxiSllmcWpRUo6Ssk5pUlghUqGRkq1AOlmHMw:1uthHn:100mdd1BMngYCHosg9jbRCGtPKlfBIU8T7Lp_Yho7GQ	2025-09-17 06:48:03.218896+00
\.
...
--
-- Data for Name: landing_page_message; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.landing_page_message (message_id, message, created_at, users_id_id) FROM stdin;
\.
...
COPY public.member_application (id, medical_form, certificate_of_recognition, student_id_card, date_submitted, club_id, student_id, signature, status) FROM stdin;
\.
...
COPY public.messages (message_id, users_id, message, created_at) FROM stdin;
1	1	Testing Chat	2025-09-01 12:04:38.605063+00
\.
...
SELECT pg_catalog.setval('public.club_application_id_seq', 2, true);
...
--
-- Name: landing_page_message_message_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.landing_page_message_message_id_seq', 1, false);
...
--
-- Name: landing_page_message landing_page_message_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.landing_page_message
    ADD CONSTRAINT landing_page_message_pkey PRIMARY KEY (message_id);
...
--
-- Name: landing_page_message_users_id_id_7793d00d; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX landing_page_message_users_id_id_7793d00d ON public.landing_page_message USING btree (users_id_id);
...
--
-- Name: landing_page_message landing_page_message_users_id_id_7793d00d_fk_auth_user_id; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.landing_page_message
    ADD CONSTRAINT landing_page_message_users_id_id_7793d00d_fk_auth_user_id FOREIGN KEY (users_id_id) REFERENCES public.auth_user(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: messages messages_users_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.messages
    ADD CONSTRAINT messages_users_id_fkey FOREIGN KEY (users_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
\unrestrict OyZfpcPB6hFM4MfF8khmXgB8QGyp5pkYA7ULlxTrTth3wY2PKwfOvkd3PmHToWt
